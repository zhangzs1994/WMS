...
public class InStockRecyclerAdapter extends RecyclerView.Adapter{
    ...
    public InStockRecyclerAdapter(Context context, List<Map<String,Object>> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType ==ITEM_TYPE_HEADER) {
            ...
            //获取内容布局
            return new InStockRecyclerHolder(LayoutInflater.from(context).inflate(R.layout.instock_recycler_item, parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        } else if (holder instanceof InStockRecyclerHolder) {
            //处理内容数据
