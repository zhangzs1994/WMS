package com.ycsx.www.wms.service;
...
public class UpdateAppService extends Service {
    ...
    private void initDownManager() {
        ...
        if(TextUtils.isEmpty(API.downLoadUrl)){
            Toast.makeText(UpdateAppService.this, "下载地址为空", Toast.LENGTH_SHORT).show();
            return;
        }

        //设置下载地址
        String urlPath = API.downLoadUrl;
