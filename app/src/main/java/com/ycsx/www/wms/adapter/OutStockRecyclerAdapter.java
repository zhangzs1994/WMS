...
public class OutStockRecyclerAdapter extends RecyclerView.Adapter{
    ...
    public OutStockRecyclerAdapter(Context context, List<Map<String,Object>> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType ==ITEM_TYPE_HEADER) {
            ...
            //获取内容布局
            return new OutStockRecyclerHolder(LayoutInflater.from(context).inflate(R.layout.outstock_recycler_item, parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        } else if (holder instanceof OutStockRecyclerHolder) {
            //处理内容数据
